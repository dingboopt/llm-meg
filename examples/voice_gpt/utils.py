...
def get_batch_on_this_tp_rank(data_iterator):
    ...
    if mpu.get_tensor_model_parallel_rank() == 0:
       ...
       batch = {
           ...
           'whisper_feats': data["whisper_feats"].cuda(non_blocking = True),
       }
       ...
       if args.pipeline_model_parallel_size == 1:
           ...
           _broadcast(batch['whisper_feats'])
       ...
       whisper_feats = torch.empty((args.micro_batch_size,1500, 1280), dtype = torch.bfloat16 , device = torch.cuda.current_device())
       attention_mask=None
